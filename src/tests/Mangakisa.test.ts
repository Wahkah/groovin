...
import { Mangakisa } from "../sources/Mangakisa/Mangakisa";

describe("Mangakisa Tests", function () {
  var wrapper: APIWrapper = new APIWrapper();
  var source: Source = new Mangakisa(cheerio);
